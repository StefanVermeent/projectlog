...
The three core aims of `projectlog` are:
  ...
  1. Help you to set up or convert your R project following best practices.
  2. Help you to easily keep track of important points in your project, such as preregistrations, first-time data access, and article submissions and revisions.
  3. Create a clear, reproducible, and verifiable history of your project---including major milestones---for others (e.g., reviewers or readers of your article).
